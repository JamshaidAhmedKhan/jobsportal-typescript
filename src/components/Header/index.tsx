...
import { CompanyLogo, Hamburger } from "../ui-icons/Icons";
...
const index: React.FC = () => {
  ...
  return (
    <>
      <div className="px-[2rem] sm:px-[4rem] md:px-[6rem] flex justify-between items-center fixed w-full py-[15px] top-0 bg-[#f8f8fd8a] z-50">
        <div className="flex items-center gap-3">
          <Link to="/" className="flex gap-1.5 mr-5 cursor-pointer">
            <CompanyLogo />
            <h6 className="font-semibold">JobHuntly</h6>
          </Link>
          <button className="font-14 hidden md:block text-[#515B6F]">
            <Link to="/findjobs">Find Jobs</Link>
          </button>
          <button className="font-14 hidden md:block text-[#515B6F] ml-1">
